...
# We will be using the resnet 18 model for our implementation
...
class resnet34_SSD300(nn.Module):
    ...
    def __init__(self, cfg, backbone=ResNet()):
        ...
        feature_channel_dict = {"38x38": 256,
                                "19x19": 512,
                                "10x10": 512,
                                "5x5": 256,
                                "3x3": 256,
...
@registry.BACKBONES.register('resnet34_SSD300')
def resnet34(cfg, pretrained=True):
    model = resnet34_SSD300(cfg)
    return model
